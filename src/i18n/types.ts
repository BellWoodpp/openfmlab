...
export interface SampleVoicesSet {
  originalName: string;
  cloneName: string;
  originalAvatarText: string;
  cloneAvatarText: string;
}
...
export interface HomeDictionary {
  ...
  sampleVoicesSubtitle: string;
  sampleVoicesOriginalLabel: string;
  sampleVoicesCloneLabel: string;
  sampleVoicesOriginalName: string;
  sampleVoicesCloneName: string;
  sampleOriginalAvatarText: string;
  sampleCloneAvatarText: string;
  sampleVoicesPlayAriaLabel: string;
  sampleVoicesPrevAriaLabel: string;
  sampleVoicesNextAriaLabel: string;
  sampleVoicesSets: SampleVoicesSet[];

  // Voice Cloning Section (target style)
  voiceCloningKicker: string;
  voiceCloningTitle: string;
  voiceCloningDescription: string;
  voiceCloningPrimaryCta: string;
  voiceCloningSecondaryCta: string;
  voiceCloningHighlights: FeatureItem[];
  voiceCloningDemoOriginalLabel: string;
  voiceCloningDemoCloneLabel: string;
